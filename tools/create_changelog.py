...
For the complete changelog, visit [here](https://github.com/noaione/ejaan-napi-rs/blob/master/CHANGELOG.md).
If you encounter any problems, please report them on the [issues](https://github.com/noaione/ejaan-napi-rs/issues/new) page.

Install this version using:
```bash
npm install @noaione/ejaan-rs@{version}
# Or
yarn add @noaione/ejaan-rs@{version}
```
